...
do
   ...
   ./mainAOScl.exe "test-$i-dim.dat" "test-$i-dim-AOSp.out" >> result_AOScl_dim.out
   ./mainSOAcl.exe "test-$i-dim.dat" "test-$i-dim-SOAp.out" >> result_SOAcl_dim.out
done
...
do
   ...
   ./mainAOScl.exe "test-$i-point.dat" "test-$z-point-SOA.out" >> result_AOScl_point.out
   ./mainSOAcl.exe "test-$i-point.dat" "test-$z-point-SOAp.out" >> result_SOAcl_point.out
done
...
do
   ...
   ./mainAOScl.exe "test-$i-grid.dat" "test-$z-grid-AOSp.out" >> result_AOScl_grid.out
   ./mainSOAcl.exe "test-$i-grid.dat" "test-$z-grid-SOAp.out" >> result_SOAcl_grid.out
done
